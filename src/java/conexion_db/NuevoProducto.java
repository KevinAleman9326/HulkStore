...
public class NuevoProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String descripcion =request.getParameter("descripcion_prod");
        
        Acciones insertarproducto = new Acciones();
        insertarproducto.insertTablaProducto(id,nombre, descripcion);
